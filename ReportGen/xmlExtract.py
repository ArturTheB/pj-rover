...
#----------------------------------------------------------------------
    def getDiagramsForPackage(self, packageHandle):
        """ Search for packages for packageHandle """

        # Search for Jude diagrams
        allJudes = self.findTags(packageHandle ,"JUDE:Diagram")
        for jude in allJudes:
            judeName = self.getAttribute(jude, "name")
            # Are the names empty?
            if judeName != None:
        ...
        #Search for JUDE:ActivityDiagram
        allJudeActivity = self.findTags(packageHandle, "JUDE:ActivityDiagram")
        for jude in allJudeActivity:
            judeName = self.getAttribute(jude, "name")
            if judeName != None:
                self.diagrams.append(judeName)
...
#----------------------------------------------------------------------
    def getUseCases(self):
        """ Stores all of use cases in self.UseCases. Only Use Case diagrams """
...
if __name__ == "__main__":
    ...
    # for ad in reportGenerator.activityDiagrams:
    #     print (reportGenerator.activityDiagrams[ad])

    # reportGenerator.getDiagramsForPackage(p2)
    # print(reportGenerator.classDiagrams)
